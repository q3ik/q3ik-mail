...
// Wrap with Sentry only when SENTRY_DSN is provided at runtime.
// This allows the worker to run in local dev / environments where
// SENTRY_DSN is not set without throwing at startup.
export default {
